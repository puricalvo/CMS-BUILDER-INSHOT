			...
			<div id="page-content-wrapper">
				...
				<?php if (!empty($routesArray[0])): ?>
					...
					<?php else: ?>
						...
						<!--======================================================
						Validar permisos para páginas dinámicas y personalizadas
						========================================================-->

						<?php if ($_SESSION["admin"]->rol_admin == "superadmin" || $_SESSION["admin"]->rol_admin == "admin" || 
							$_SESSION["admin"]->rol_admin == "editor" && isset(json_decode(urldecode($_SESSION["admin"]->permissions_admin), true)[$routesArray[0]]) &&
				...
				<?php else: ?>
					...
					<!--=========================================
					Validamos permisos para superadmin y admins
					===========================================-->
					<?php if ($_SESSION["admin"]->rol_admin == "superadmin" || $_SESSION["admin"]->rol_admin == "admin"): ?>
					...
					<!--=========================================
					Validamos permisos para editores
					===========================================-->
